...
class Regions(models.Model):
    ...
    name = models.CharField(verbose_name='name', max_length=64, unique=True)
    description = models.TextField(verbose_name="description", blank=True)
    is_active= models.BooleanField(verbose_name="is ctive", default=True)
...
class Accommodation(models.Model):
    ...
    short_desc = models.TextField(verbose_name='producct Short Descr', max_length=60, blank=True)
